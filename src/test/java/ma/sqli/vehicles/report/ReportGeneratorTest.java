...
public class ReportGeneratorTest {
    ...
    public void testFactory(){
        ...
        ReportGenerator report = ReportGeneratorFactory.getReportGenerator(car, "1 2 3 4");
        Assert.assertTrue(report instanceof DoorsOkReportGenerator);

        report = ReportGeneratorFactory.getReportGenerator(truck, "1 2");
        Assert.assertTrue(report instanceof DoorsOkReportGenerator);

        report = ReportGeneratorFactory.getReportGenerator(car, "1 2 4");
        Assert.assertTrue(report instanceof DoorsKoReportGenerator);

        report = ReportGeneratorFactory.getReportGenerator(truck, "2");
        Assert.assertTrue(report instanceof DoorsKoReportGenerator);
    }
